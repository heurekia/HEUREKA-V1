  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      mesures: [
        ...
        {
          titre: "Droits des personnes (accès, rectification, effacement, portabilité)",
          description: "Procédures techniques à exposer au citoyen depuis l'espace « Profil » : export JSON/CSV de son dossier, suppression de compte, contact DPD de la mairie.",
          reference: "RGPD art. 15-22",
          statut: "a_faire",
        },
      ],
    },
    {
      ...
      mesures: [
        ...
        {
          titre: "LLM Anthropic via région UE",
          description: "Bascule recommandée d'Anthropic API (US) vers Anthropic via AWS Bedrock région eu-central-1 (Francfort). Supprime juridiquement le transfert hors UE.",
