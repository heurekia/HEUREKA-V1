...
async function seed() {
  ...
  // SAINT-AVERTIN
  // ════════════════════════════════════════════════════════════
  const communeSA = await upsertCommune({ name: "Saint-Avertin", insee_code: "37226", zip_code: "37550" });
  ...
  // LA RICHE
  // ════════════════════════════════════════════════════════════
  const communeLR = await upsertCommune({ name: "La Riche", insee_code: "37132", zip_code: "37520" });
