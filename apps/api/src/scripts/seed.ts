...
async function seed() {
  ...
  const dJT005 = await upsertDossier({ numero: "PC-JT-2024-018", type: "permis_de_construire"  as const, status: "soumis"            as const, user_id: citoyenJT1.id,                                   parcelle: "JT 018", adresse: "45 Boulevard Général Leclerc",  commune: "Joué-lès-Tours", code_postal: "37300", description: "Construction d'un local commercial de 180 m² avec logement", surface_plancher: "245", date_depot: new Date("2026-05-20"), date_limite_instruction: new Date("2026-07-20"), metadata: {} });
  ...
  const dLR001 = await upsertDossier({ numero: "PC-LR-2024-002", type: "permis_de_construire"  as const, status: "en_instruction" as const, user_id: citoyenLR1.id, instructeur_id: instructeurLR.id, parcelle: "LR 002", adresse: "18 Rue de la Choisille",  commune: "La Riche", code_postal: "37520", description: "Construction d'une maison individuelle BBC de 95 m²", surface_plancher: "95",  date_depot: new Date("2026-05-07"), date_completude: new Date("2026-05-12"), date_limite_instruction: new Date("2026-07-07"), metadata: {} });
