...
// par dossier, par modèle, par usage métier (analyse de pièce, extraction,
// verdicts règle-par-règle, ingestion PLU…). Inséré par le wrapper
// `callClaude()` dans apps/api/src/services/aiUsage.ts.
